...
class MyDB:
    ...
    def __init__(self, config_file, db):
        ...
        try:
            self.dbconn = pymysql.connect(host=host,port=9892,user=user,password=passwd,database=db_name,charset=charset)
            #self.dbconn = pymysql.connect(host='host', port='port', user='user', password='passwd', database='db_name', charset="utf-8")
